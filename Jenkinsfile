pipeline{
    ...
    environment {
        env=getEnvironment(env.BRANCH_NAME, env.BRANCH_DEV, env.BRANCH_PROD)
...
def getRegion(String branchOrTag, String BRANCH_DEV,String BRANCH_DEV, String BRANCH_STAGE, String BRANCH_PROD) {
